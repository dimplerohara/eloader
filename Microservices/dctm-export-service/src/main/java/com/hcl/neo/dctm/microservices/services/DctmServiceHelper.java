...
public class DctmServiceHelper {
	...
	public void createPath(DctmDao dctmDao, String path) throws DctmException, Throwable{
		if(null == path || path.isEmpty()){
			throw new DctmException(String.format(Constants.MSG_INVALID_PATH, path));
		}
		path = path.trim();
