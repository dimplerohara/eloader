...
import com.hcl.neo.dctm.microservices.excel.schema_metadata.Object;
...
public class ProcessObject {
    ...
    public String getFormat() {        
        if (getId() != null && getId().startsWith("09")) {
            return "Document";
        } else if (getId() != null && getId().startsWith("0b")) {
            return "Folder";
        } else if (getId() != null && getId().startsWith("0c")) {
            return "Cabinet";
        } else {
            return "DCTM Object";
        }
