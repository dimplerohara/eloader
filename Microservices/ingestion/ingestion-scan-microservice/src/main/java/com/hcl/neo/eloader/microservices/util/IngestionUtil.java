...
public class IngestionUtil {
	...
	public void createTGZFile(String strSourceLocation,String transportServerPath, String uploadDirPath,String targetFileName,SessionParams sessionParams) throws SocketException, IOException, JSchException, SftpException{ 
		...
		try{
			...
			String command="cd "+strSourceLocation+"; tar czf "+TGZUploadPath+" --exclude file.txt .";
	...
	public boolean checkFileTxt(ChannelSftp channelSftp, String strSourceLocation) throws SftpException{
	...
	public Session connectToSFTPServer() throws JSchException {
		TransportServerMaster record = transportServerRepository.findByServerId(xportServerId);
		SessionParams sessionParams = toSessionParam(record);
	...
	public ArrayList<String> getFilePath(ChannelSftp channelSftp, String strSourceLocation,ArrayList<String> selectedFilePaths) throws SftpException {
		...
		System.out.println(selectedFilePaths);
