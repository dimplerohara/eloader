package com.hcl.neo.eloader.impl;
...
import com.hcl.neo.eloader.model.SequenceId;
...
public class SequenceDaoImpl implements SequenceDao{
	...
	public long getNextSequenceId(String key) throws Exception {
	  ...
	  SequenceId seqId =
            mongoOperation.findAndModify(query, update, options.upsert(true), SequenceId.class);
