...
public class DctmImportMetadataService {

	protected Logger logger = Logger.getLogger(DctmImportMetadataService.class.getName());
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(DctmImportMetadataService.class, args);
	}
}
