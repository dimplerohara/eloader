...
public class UploadJobInfo implements Serializable{
	...
	public String toString() {
		return "UploadJobInfo [parentFile=" + parentFile + ", defaultFolderType=" + defaultFolderType + ", folderTypes="
				...
				+ folderCount + ", contentSize=" + contentSize + ", packageSize=" + packageSize + ", landZoneId="
				+ landZoneId + ", illegalObjectList=" + illegalObjectList + ", selectedFilePaths=" + selectedFilePaths
				+ ", businessGroup=" + businessGroup + ", jobName=" + jobName + ", checksum=" + checksum
				+ ", transportServerPath=" + transportServerPath + "]";
	}    
}
