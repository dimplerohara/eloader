...
public class OutboundJobProcessor extends JobProcessor {
	...
	private BulkJobParams toBulkJobParams(JobMaster job){
		...
		bulkJobParams.setName(job.getName());
		bulkJobParams.setType(BulkJobType.valueOf(job.getType()));
		bulkJobParams.setRepositoryId(job.repositoryId);
		bulkJobParams.setRepositoryPaths(job.repositoryPath);
		bulkJobParams.setTransportServerId(job.transportServerId);
		bulkJobParams.setTransportServerPath(job.transportServerPath);
