...
class DctmDaoImpl extends DctmDaoBase implements DctmDao{
	...
	public boolean deleteObjectMetadata(DeleteMetadataParam params) throws DctmException {
		return new DeleteMetadataImpl(getSession()).deleteProperties(params);
	}
	...
	@Override
	public List<Map<String, String>> getSearchResult(SearchObjectParam param) throws DctmException {
		return new GetSearchResultImpl(getSession()).getResults(param);
	}
